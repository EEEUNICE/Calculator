    ...
    while (!operators.empty()) {  
        if (!sign) {  
            ...
            if (isOperator(ch) == 3) { //如果ch不是操作数也不是操作符  
                cout << "Error in infix notation. Sorry,expressions containing illegal characters." << endl;  
                cout << "Please re-enter!" << endl;  
                cout << endl;  
                return;  
            }  
            else if (ch == '='&&loc != length - 1) {//=符号出现在中间  
                cout << "Error in infix notation. \'=\' couldn't in the middle of arithmetic expression!" << endl;  
                cout << "Please re-enter!" << endl;  
                cout << endl;  
                return;  
            }  
                ...
                if (wrong == 1) {  
                    cout << "Error in infix notation. Divisor can not be zero!" << endl;  
                    cout << "Please re-enter!" << endl;  
                    cout << endl;  
                    return;  
                }  
